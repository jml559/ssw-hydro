...
""" n_events = 14 ###
n_lat = 361
n_lon = 576 # (180, 360) if regridded?
N_resamples = 10000 

ds_comp = pyg.open(path + "PRECTOTCORR_DJFM_composite_2000to2020.nc") ###
#print(ds_comp)
...
map = dict(projection = "NorthPolarStereo")
ax1 = pyg.showvar(3600*24*prectot_comp_before_ssw, map=map, **cm) # map = map
...
fn1 = "ps_MERRA2_before_SSWs_DJFM_2000to2020.pdf" ### change as neeeded
...
map = dict(projection = "NorthPolarStereo")
ax2 = pyg.showvar(3600*24*prectot_comp_after_ssw, map=map, **cm) # map = map
...
fn2 = "ps_MERRA2_after_SSWs_DJFM_2000to2020.pdf" ### change as needed
